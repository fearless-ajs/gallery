...
<div>
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>System Open House Page </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">pages</li>
                        <li class="breadcrumb-item active">Open house</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Update open house page content</h3>
                ...
                <div class="card-body">
                    <form wire:submit.prevent="save">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Information Background Image<sup>(1920 X 1024)</sup></label>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea cols="20" wire:model.lazy="content" rows="5" class="form-control {{$errors->has('instagram')? 'is-invalid' : '' }}" placeholder="Information content here..."></textarea>
