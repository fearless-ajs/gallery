            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('album.edit', $album->album->album->id)}}">{{$album->album->album->title}}</a></li>
                        <li class="breadcrumb-item"><a href="{{route('sub-albums.all', $album->album->id)}}">Albums</a></li>
                        <li class="breadcrumb-item"><a href="{{route('sub-album.edit', $album->album->id)}}">{{$album->album->title}}</a></li>
                        <li class="breadcrumb-item"><a href="{{route('sub-sub-albums.all', $album->id)}}">Albums</a></li>
                        <li class="breadcrumb-item"><a href="{{route('sub-sub-album.edit', $album->id)}}">{{$album->title}}</a></li>
