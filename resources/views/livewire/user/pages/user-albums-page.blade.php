        ...
        <div   id="portfolio_horizontal_container" class="three-ver-columns lightgallery">
            ...
            <div class="portfolio_item {{$album->content}}">
                <div class="grid-item-holder">
                    ...
                    <a href="{{route('user.pictures', $album->id)}}"><img src="{{$album->ImagePath}}" alt=""></a>
                    <div class="thumb-info">
                        <h3><a href="{{route('user.pictures', $album->id)}}">{{$album->title}}</a></h3>
                    </div>
                    @endif
                    @if($album->content == 'Albums')
                         <a href="{{route('user.sub-albums', $album->id)}}"><img src="{{$album->ImagePath}}" alt=""></a>
                            <div class="thumb-info">
                                <h3><a href="{{route('user.sub-albums', $album->id)}}">{{$album->title}}</a></h3>
                            </div>
                        @endif
                </div>
            </div>
