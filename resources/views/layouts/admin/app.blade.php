...
<head>
    ...
    <link href="{{asset('admin/file_upload/css/fileinput.css')}}" media="all" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css" crossorigin="anonymous">
    <link href="{{asset('admin/file_upload/themes/explorer-fas/theme.css')}}" media="all" rel="stylesheet" type="text/css"/>
    <link href="{{asset('admin/filepond/dropzone.css')}}" media="all" rel="stylesheet" type="text/css"/>
    <link href="{{asset('admin/filepond/basic.css')}}" media="all" rel="stylesheet" type="text/css"/>
...
<script src="{{asset('admin/file_upload/js/plugins/piexif.js')}}" type="text/javascript"></script>
<script src="{{asset('admin/file_upload/js/plugins/sortable.js')}}" type="text/javascript"></script>
<script src="{{asset('admin/file_upload/js/fileinput.js')}}" type="text/javascript"></script>
<script src="{{asset('admin/file_upload/js/locales/fr.js')}}" type="text/javascript"></script>
<script src="{{asset('admin/file_upload/js/locales/es.js')}}" type="text/javascript"></script>
<script src="{{asset('admin/file_upload/themes/fas/theme.js')}}" type="text/javascript"></script>
<script src="{{asset('admin/file_upload/themes/explorer-fas/theme.js')}}" type="text/javascript"></script>
