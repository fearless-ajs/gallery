...
class EditAlbumPage extends Component
{
    ...
    {
        $pictures  = Picture::where('album_id', $this->album_id)->count();
        $sub_album = SubAlbum::where('album_id', $this->album_id)->count();
    ...
    public function save()
    {
        ...
        Album::where('id', $this->album_id)->update([
            'title'   => $this->title,
    ...
    {
        return view('livewire.admin.pages.edit-album-page');
    }
}
